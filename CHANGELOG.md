...
- B50: fixed empty Character Overview Curio slots retaining Darktide's native placeholder blueprint after a Curio is equipped. The widget now rebuilds immediately in both empty→equipped and equipped→empty directions, preserving callbacks and placement; regression coverage added.
