...
- Gives the Better Inventory name in Mod Options an always-on per-character gradient from bright sage-lime `#C9F27B` to copper `#D9784A`, distinct from Alf's yellow-to-magenta branding.
