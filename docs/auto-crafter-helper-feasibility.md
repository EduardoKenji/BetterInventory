...
- Keep account mutations serialized and require an explicit Start click plus current authoritative preflight; the development profile now defaults the mutation gate on to match the validated in-game configuration.
