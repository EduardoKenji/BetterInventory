local localization = {
	...
	global_store_character_photo_size_percent_tooltip = {
		en = "Controls the GlobalStore character photo size in three-to-five-column cards (50-125%%, with 110%% as the default). The character row remains below the price and item-level row while its reserved height stays fixed, so changing this value does not change card dimensions or move the price.",
	},
	...
	global_store_character_class_icon_size_tooltip = {
		en = "Controls the GlobalStore class icon font size in three-to-five-column cards (8-24 px, default 16). The character row and card dimensions stay fixed.",
	},
	...
	global_store_character_name_font_size_tooltip = {
		en = "Controls the GlobalStore character name font size in three-to-five-column cards (8-20 px, default 16). The character row and card dimensions stay fixed.",
	},
...
zh_cn.global_store_character_photo_size_percent_tooltip = "控制三至五列卡片中的 GlobalStore 角色头像大小（50-125%%，默认110%%）。角色信息行位于价格和物品等级行下方，预留高度保持不变，因此调整此值不会改变卡片尺寸或使价格移动。"
...
zh_cn.global_store_character_class_icon_size_tooltip = "控制三至五列卡片中的 GlobalStore 职业图标字号（8-24像素，默认16）。角色信息行和卡片尺寸保持不变。"
zh_cn.global_store_character_name_font_size = "GlobalStore 角色名称字号"
zh_cn.global_store_character_name_font_size_tooltip = "控制三至五列卡片中的 GlobalStore 角色名称字号（8-20像素，默认16）。角色信息行和卡片尺寸保持不变。"
