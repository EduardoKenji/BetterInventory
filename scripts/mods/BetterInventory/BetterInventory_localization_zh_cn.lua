...
localization.auto_crafter_target_dump_stat_tooltip = "规划器必填目标。自动发现会从当前选中的布伦特武器预览中解析最低有效基础属性；伤害仍可手动指定。"
localization.auto_crafter_dump_stat_damage = "伤害"
localization.auto_crafter_dump_stat_auto = "自动发现"
localization.auto_crafter_dump_stat_auto_pending = "自动发现（等待武器预览）"
