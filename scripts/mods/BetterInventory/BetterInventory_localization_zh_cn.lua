...
localization.auto_crafter_target_dump_stat_tooltip = "规划器必填目标。伤害是安全默认值；自动发现预留给后续修改阶段的动态候选属性发现。"
localization.auto_crafter_dump_stat_damage = "伤害"
localization.auto_crafter_dump_stat_auto = "自动发现（未来）"
...
localization.auto_crafter_docket_cap = "自动制作奥多券上限"
