...
localization.auto_crafter_show_probe_notifications_tooltip = "默认启用。只读探测开始、完成或失败后显示原生通知。通知错误不会影响游戏数据。"
...
localization.auto_crafter_panel_offer_list = "武器商品"
...
localization.auto_crafter_dump_stat_target_tooltip = "目标低项属性百分比。阶段 1B 仅验证该数值，不会购买或修改物品。"
localization.auto_crafter_docket_cap = "自动制作奥多券上限"
localization.auto_crafter_docket_cap_tooltip = "未来购买循环可使用的奥多券上限。阶段 1B 仅报告成本范围，不会消费奥多券。"
localization.auto_crafter_max_purchases = "自动制作最大购买次数"
localization.auto_crafter_max_purchases_tooltip = "未来串行搜索循环的硬上限。阶段 1B 仅用于预检和成本规划。"
localization.auto_crafter_best_candidate_fallback = "未命中目标时保留最佳候选"
localization.auto_crafter_best_candidate_fallback_tooltip = "未来循环在达到上限仍未找到精确目标时保留最接近的低项属性候选。默认关闭。"
...
localization.auto_crafter_panel_preview = "制作（只读预览）"
localization.auto_crafter_panel_read_only_preview = "只读；不修改数据"
