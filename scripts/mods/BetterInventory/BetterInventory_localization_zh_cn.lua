...
localization.image_layout_grid_profile_tooltip = "Selects which independent column layout is shown below for editing. Cards automatically use the profile matching their actual column count."
