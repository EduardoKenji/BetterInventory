...
localization.auto_crafter_panel_base_level_range = "生成的基础物品等级范围"
localization.auto_crafter_panel_consecrate_cost = "亵渎至超凡"
localization.auto_crafter_panel_expertise_cost = "基础物品等级提升至 500"
localization.auto_crafter_panel_mastery_fodder = "精通 20 级祭品"
...
localization.auto_crafter_panel_stop = "停止当前流程"
localization.auto_crafter_panel_stop_detail = "等待进行中的请求完成后停止"
...
localization.auto_crafter_panel_saved_only = "运行范围"
localization.auto_crafter_panel_not_connected = "购买搜索和精通循环已连接；其余选项仅保存为计划。"
