...
localization.auto_crafter_allow_mutations = "允许自动制作助手修改账户"
localization.auto_crafter_allow_mutations_tooltip = "默认关闭。显式授权串行布伦特购买和阶段 2 单件升级至 Redeemed/牺牲验证。不启用自动精通 20、词缀、祝福、收藏或改名。"
...
localization.auto_crafter_panel_melee_weapons = "近战武器"
localization.auto_crafter_panel_ranged_weapons = "远程武器"
...
localization.auto_crafter_target_dump_stat_tooltip = "可手动选择低项属性。布伦特窗口会显示当前武器已发现的基础属性；自动发现只是最后一个推荐选项，不会覆盖手动选择。"
...
localization.auto_crafter_dump_stat_auto = "自动发现推荐"
localization.auto_crafter_dump_stat_auto_unavailable = "自动推荐不可用（请选择属性）"
localization.auto_crafter_dump_stat_auto_pending = "自动发现推荐（等待武器预览）"
...
localization.auto_crafter_buy_until_target = "购买直到找到低项属性目标"
...
localization.auto_crafter_level_mastery_20_tooltip = "目前仅为界面规划选项。后续将重复受保护的购买、升级、牺牲、领取和同步流程，直到权威精通达到 20 级。"
...
localization.auto_crafter_consecrate_transcendent = "将武器祝圣为超凡"
localization.auto_crafter_consecrate_transcendent_tooltip = "目前仅为界面规划选项。后续只会为最终候选补充缺少的稀有度阶段。"
localization.auto_crafter_upgrade_expertise_500 = "将武器专精提升至 500"
localization.auto_crafter_upgrade_expertise_500_tooltip = "目前仅为界面规划选项。精通奖励允许后，最终候选将提升至 500 专精。"
localization.auto_crafter_change_perks = "更改专长"
localization.auto_crafter_change_perks_tooltip = "目前仅为界面规划选项。专长目标发现和替换尚未连接。"
...
localization.auto_crafter_perk_target_tooltip = "在游戏数据目录可填充兼容专长前使用的占位策略。保留当前不会替换；自动选择会保存但不会执行。"
...
localization.auto_crafter_rename_result = "重命名最终武器"
localization.auto_crafter_rename_result_tooltip = "默认关闭。后续连接需要经过测试的 BetterInventory 或 Name It 命名提供器以及稳定的最终装备 ID。"
...
localization.auto_crafter_panel_preflight = "预检"
localization.auto_crafter_panel_preview = "制作/购买搜索"
localization.auto_crafter_panel_read_only_preview = "只读预览"
localization.auto_crafter_panel_serial_start = "串行；点击开始"
localization.auto_crafter_panel_mutation_gate = "修改开关"
localization.auto_crafter_panel_phase_2 = "升级并牺牲一件"
localization.auto_crafter_panel_phase_2_waiting = "没有已购买候选"
localization.auto_crafter_panel_mutations_on = "串行修改已启用"
localization.auto_crafter_panel_mutations_off = "修改已关闭"
...
localization.auto_crafter_panel_output = "最终物品处理"
localization.auto_crafter_panel_saved_only = "已保存配置"
localization.auto_crafter_panel_not_connected = "后续阶段会连接这些选项。当前阶段 1/2 操作仍单独受保护。"
localization.auto_crafter_panel_option_unavailable = "请启用前置选项"
localization.auto_crafter_panel_result_name = "结果名称"
localization.auto_crafter_panel_name_provider_later = "命名提供器连接尚在计划中"
