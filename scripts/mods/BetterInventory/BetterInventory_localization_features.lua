local localization = {
	...
	auto_crafter_max_purchases_tooltip = {
		en = "Configured upper bound for the serialized purchase search. No additional hidden purchase limit is applied.",
	},
	...
	custom_tier_god_stat_checker_background_owner = { en = "Background colour owner" },
	god_stat_checker_integration_group = { en = "Mod integration: God Stat Checker 1.1.2" },
	god_stat_checker_background_owner = { en = "Background colour owner" },
	...
	custom_tier_melee_group = { en = "Melee weapon criteria" },
	custom_tier_ranged_group = { en = "Ranged weapon criteria" },
	custom_tier_melee_enabled = { en = "Classify qualifying melee weapons" },
	custom_tier_ranged_enabled = { en = "Classify qualifying ranged weapons" },
	custom_tier_weapon_enabled_tooltip = { en = "Apply the custom tier to this weapon category when every enabled filter below passes." },
	custom_tier_melee_min_power = { en = "Minimum melee Power" },
	custom_tier_ranged_min_power = { en = "Minimum ranged Power" },
	custom_tier_weapon_min_power_tooltip = { en = "Minimum displayed weapon Power. The reference behavior uses 500." },
	custom_tier_melee_min_base_stat_total = { en = "Minimum melee base-stat total" },
	custom_tier_ranged_min_base_stat_total = { en = "Minimum ranged base-stat total" },
	custom_tier_weapon_min_base_stat_total_tooltip = { en = "Require the sum of all base modifiers to reach this value. Zero disables this filter." },
	custom_tier_melee_min_modifier = { en = "Minimum value for every melee modifier" },
	custom_tier_ranged_min_modifier = { en = "Minimum value for every ranged modifier" },
	custom_tier_weapon_min_modifier_tooltip = { en = "Require every base modifier to reach this value. Zero disables this filter." },
	custom_tier_melee_required_high_stats = { en = "Required high melee modifiers" },
	custom_tier_ranged_required_high_stats = { en = "Required high ranged modifiers" },
	custom_tier_weapon_required_high_stats_tooltip = { en = "Number of base modifiers that must reach the high-stat threshold. Zero disables this filter." },
	custom_tier_melee_high_stat_threshold = { en = "Melee high-stat threshold" },
	custom_tier_ranged_high_stat_threshold = { en = "Ranged high-stat threshold" },
	custom_tier_weapon_high_stat_threshold_tooltip = { en = "A modifier at or above this value counts as a high stat." },
	custom_tier_curios_group = { en = "Curio criteria" },
	custom_tier_curio_health_group = { en = "Health Curios" },
	custom_tier_curio_toughness_group = { en = "Toughness Curios" },
	custom_tier_curio_stamina_group = { en = "Stamina Curios" },
	custom_tier_curio_wounds_group = { en = "Wound Curios" },
	custom_tier_curio_health_enabled = { en = "Classify qualifying Health Curios" },
	custom_tier_curio_toughness_enabled = { en = "Classify qualifying Toughness Curios" },
	custom_tier_curio_stamina_enabled = { en = "Classify qualifying Stamina Curios" },
	custom_tier_curio_wounds_enabled = { en = "Classify qualifying Wound Curios" },
	custom_tier_curio_enabled_tooltip = { en = "Apply the custom tier to this Curio primary-stat type when its roll and Power filters both pass." },
	custom_tier_curio_health_min_roll = { en = "Minimum Health roll (%%)" },
	custom_tier_curio_toughness_min_roll = { en = "Minimum Toughness roll (%%)" },
	custom_tier_curio_stamina_min_roll = { en = "Minimum Stamina roll" },
	custom_tier_curio_wounds_min_roll = { en = "Minimum Wounds roll" },
	custom_tier_curio_min_roll_tooltip = { en = "Minimum displayed value for this Curio's primary stat. Defaults reproduce Red Weapons At Home's maximum-roll criteria." },
	custom_tier_curio_health_min_power = { en = "Minimum Health Curio Power" },
	custom_tier_curio_toughness_min_power = { en = "Minimum Toughness Curio Power" },
	custom_tier_curio_stamina_min_power = { en = "Minimum Stamina Curio Power" },
	custom_tier_curio_wounds_min_power = { en = "Minimum Wound Curio Power" },
	custom_tier_curio_min_power_tooltip = { en = "Minimum displayed Curio Power. Zero reproduces Red Weapons At Home's default rating threshold." },
