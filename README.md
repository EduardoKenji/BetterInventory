...
- Weapon perk text has synchronized color presets and RGB sliders plus an independent 0–100% opacity slider. Its default Light green preset (`RGB 190, 210, 180`) is the former blessing-text default.
