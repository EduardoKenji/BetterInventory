...
- GlobalStore's Multi-Operative Supply can be enabled or left native through the **Mod Integration: GlobalStore** subsection. Integrated cards move the character portrait/class/name to the lower-left and the Ordo Dockets cost to the lower-right; three-to-five-column cards reserve an additional character row and keep weapon art at its original height. The same collapsible **Sorting** and **Darktide Native Sorting** widget is available when the GlobalStore grid is enabled.
