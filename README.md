...
- A **Darktide Native Sorting** panel in Requisition Weapons & Curios exposes every native Armoury sort choice as a direct button. BetterInventory's equipped/favorite and perfect-roll priorities remain the outer comparator tier, while the selected native power, rarity, price or name order breaks ties within each priority group.
