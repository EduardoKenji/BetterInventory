...
- Character overview now has independent default-on melee and ranged switches that replace the equipped weapon slots with the detailed single-column inventory card. The integration is limited to the overview's individual weapon widgets; inventory tabs and Curio slots remain unchanged.
