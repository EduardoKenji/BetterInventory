...
> Project status: BetterInventory v2.2.4 development. Account-changing workflows remain opt-in and disabled by default.
>
...
The following integrations are supported in v2.2.4. BetterInventory has no optional mod dependencies; each integration activates only when its corresponding mod is installed.
