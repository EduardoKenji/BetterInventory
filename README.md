...
- An optional strict single-line weapon-title policy. Long standard or customized names shrink to the configured minimum font size, then use an ellipsis while preserving an appended `Mk` suffix.
