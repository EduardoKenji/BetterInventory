...
- A dedicated three-column weapon-name font-size control (14 px by default) so long Armoury, Hadron and inventory names can be kept compact while other column counts retain the general item-name setting.
