...
def validate_auto_crafter_mutation_boundaries() -> int:
    ...
    backend_contract = (
		...
		"summarize_potential_base_stats",
		"Items.preview_stats_change",
		"Items.max_expertise_level",
        "Items.set_item_id_as_favorite",
        "Items.is_item_id_favorited",
        "ProfileUtils.get_profile_presets",
        '"delete_gear_batch"',
    ...
    controller_contract = (
        ...
        "replacement_dump_stat(plan, config.dump_stat, previous_plan)",
        "_phase3_check_mastery",
        "_phase3_start_fodder",
        "_phase3_process_deferred",
        "_phase3_discard_deferred",
        "auto_crafter_defer_bad_weapon_processing",
        "phase3_deferred_cleanup_complete",
        "phase3_complete",
